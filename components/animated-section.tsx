...
export function AnimatedSection({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute left-1/2 -top-20 w-px h-20 bg-black/10 dark:bg-white/10"
        style={{
      ...
      <motion.div
        className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-black/10 dark:via-white/10 to-transparent"
        style={{
